...
3. **Use the John toolkit** `ppx_parse.py` (jyppx in-process wrapper) when you want layout-aware parsing without round-tripping through the parse server. Same quality, faster for batch.

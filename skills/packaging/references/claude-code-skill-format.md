...
The format is documented in Claude Code's plugin docs and exemplified by every shipped skill in this plugin (M1 + M3) and by Anthropic's official skill-creator (in workspace `/skills/skill-creator/SKILL.md`).

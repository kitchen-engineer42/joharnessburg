...
Discipline distilled from kc_cli's `events.jsonl` pattern + our own DEVLOG.md practice (workspace dev journal, same shape: append-only, most-recent-first) + Trellis's per-developer journals.

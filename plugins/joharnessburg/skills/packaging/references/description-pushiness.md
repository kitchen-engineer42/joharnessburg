...
If overtriggering, narrow the description. If undertriggering, broaden it. M6's skill-creator description-optimization loop (`run_loop.py`) automates this calibration if needed.

## Source

skill-creator skill documents this in detail at `/Users/mac/Desktop/john/skills/skill-creator/SKILL.md` on the dev machine. The `run_loop.py` script does automated description optimization with a held-out test set.

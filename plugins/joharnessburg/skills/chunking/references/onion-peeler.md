...
`pdf2skills/onion_peeler.py` is at `/Users/mac/Desktop/cc_projects/pdf2skills/onion_peeler.py`. The Python implementation has the recursive-peel + LLM-wedge logic. The updated version in `Anything2Ontology/src/markdown2chunks/` is more modular.

...
The 5 subsites are in `/Users/mac/Desktop/john/subsites/` on the dev machine. Each has its own README and design docs; the M3 spec audits captured deeper analysis. Production's `skills2app` (in `/Users/mac/Desktop/john/production/skills2app`) builds apps like these via Celery — that's the system John eventually replaces.

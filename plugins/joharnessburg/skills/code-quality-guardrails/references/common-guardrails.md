...
Categories synthesized from a production app-builder's patterns and its code-quality reviews, plus a reference app's 15+ documented deterministic guardrails.

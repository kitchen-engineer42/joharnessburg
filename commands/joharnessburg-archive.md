---
description: Bundle the finished John workspace (PLAN.md, CLAUDE.md, .john/, .claude/skills/) into a release zip. Use when the user says "archive this project", "package it up", "we're done", or you've completed M6-style end-to-end work and want a portable bundle. Excludes git/__pycache__/node_modules cruft.
